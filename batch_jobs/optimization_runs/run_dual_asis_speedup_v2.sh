...
### Job Name:
#BSUB -J run_replication_speedup_v2
...
### multi agent
python main_a2c_multi_agent.py --city nyc_man_south --mode 2 --checkpoint_path my_dual_agent_speedup_v2 --wandb_group optimization_runs
