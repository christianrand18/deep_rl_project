...
### Job Name:
#BSUB -J run_replication_parallel_4
...
### multi agent
python main_a2c_multi_agent_parallel.py --n_workers 4 --max_episodes 100000 --city nyc_man_south --mode 2 --checkpoint_path my_dual_agent_parallel_4
