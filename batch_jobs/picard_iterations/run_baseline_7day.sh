...
### Baseline: 7-day sequential (no Picard), bm_gamma=1 — direct comparison to run_picard_7day_bmg1
python main_a2c_multi_agent.py \
    --city nyc_man_south \
    --mode 2 \
    --checkpoint_path picard_baseline_7day \
