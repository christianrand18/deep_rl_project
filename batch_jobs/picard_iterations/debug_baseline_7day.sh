...
### Debug: plain sequential baseline — reference point for all ablations.
### No seeding, no lagged obs, no Picard. Everything else held constant.
python main_a2c_multi_agent.py \
    --city nyc_man_south \
    --mode 2 \
    --checkpoint_path debug_baseline_7day \
