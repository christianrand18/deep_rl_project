...
### Job Name:
#BSUB -J picard_7day_bmg1_damped
...
### Picard: 7-day episode, bm_gamma=1, damped update (omega=0.7) — tests whether damping
### suppresses the per-iteration oscillation observed in run_picard_7day_bmg1
python main_a2c_multi_agent.py \
    --city nyc_man_south \
    --mode 2 \
    --checkpoint_path picard_7day_bmg1_damped \
