...
### Job Name:
#BSUB -J picard_7day_bmg1_anderson_tol5e3_seed20
...
### Picard: 7-day, bm_gamma=1, Anderson acceleration (m=5, tol=5e-3), seed=20
python main_a2c_multi_agent.py \
    --city nyc_man_south \
    --mode 2 \
    --checkpoint_path picard_7day_bmg1_anderson_tol5e3_seed20 \
